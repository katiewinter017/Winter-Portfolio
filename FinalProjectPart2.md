...
| --- | --- | --- |
| What did you like? | **1**: I really liked the chart that showed that Art Museums do just as good as healthcare, if not better. That statistic is completely unexpected. I felt overall the infographic did a great job at highlighting salary disparity in the art world and I really enjoyed the charts used throughout the project. **2** I love the large images and large graphs. I also like how the salaries are in orange, they stick out more to me **3:** Great design overall, Great pictures |No big changes to make here- I am going to make sure the design stays neat throughout as I write out my narrative|
| What worked well? | **1:** I personally felt that the charts and the structure of the job profiles worked really well. It made it easy to discern what information was important. **2** The simplicity of the design I think worked well. It made sense flowing together as I scrolled through **3:** 1st Graph: Works well horizontal, Graphs are simple enough to understand for all audiences. |  No big changes here either, just going to make sure the flow stays consistent and readable throughout. I want to also make sure my graphs have some more context so they continue to work well with the narrative built out |
| What did not work well/was confusing? | **1:** The biggest issue I found was under the Privilege section the text was black with an extremely dark background, making it very difficult to read. I also would like to see the What can you do section be larger, with a proper heading and more points and/or sources for how to help change the disparities.**2:** I dont think I understand whats happening in all of the graphs. I think more information would help because I definitely have to stop and think about what I am seeing **3:** The first graph: The Carnegie Museum is significantly less than the rest and is not "Just as Good" as the title suggests. The second graph: I don't know what "Incomparable to One Self-Reported Income" means. Final Graph: Pop-Up boxes are not filled out. |  Need to make sure pop-up boxes are finalized, and give more context to the graphs. Need to improve the titles and make sure the narrative compliments the titles. Also need to finish building out the 'privilege' section and ensure it stays readable and flow well with the other graphics |
| What would you change? | **1** I would change the Privilege section to have different colored text and I would do a quick font check to ensure that all of the font types match throughout the course of the infographic. I would also recommend keeping a consistent color theme for the text/text background (i.e. black slides with white text are common at the start of the infographic, but eventually white slides with black text become common through the majority of the infographic, before finally reverting back to black slides at the end).**2** I would improve the titles on the graphs to be a bit clearer. Also maybe add some more context as to what exaclty the viewer is seeing in each visual **3:** The things I listed above. | Need to make sure design stays consistent. Need to re-evaluate the titles and flow of visualizations and make sure they are complimenting eachother and that their relationships are clear to the viewer. Also need to make sure the narrative is clear throughout. I will finish building out the 'privilege' section and ensure that makes better sense  |
| Did you find the story and data compelling? | **1:** I absolutely found the data and the story it tells to be compelling. I personally love infographics and think that this is one of the most powerful was to really highlight the disparity that exists in the art world. I’m curious to see how this trend exists across other industries, because I would assume the conclusions are similar in that line level workers (which sometimes require extensive education or training) are often severely underpaid in comparison to executives. I would love to hear more of this story be told and expanded upon! **2:** The data really frustrated me so it was compelling in that sense. Because of that, maybe build out the call to action more so it ends a bit more uplifting and hopeful **3:** This paints a great picture and I can easily follow the data. I think the story shifts well from salary gaps to livable wages. I clearly see your setup, conflict, and resolution. |  I am glad the data is compelling but agree the CTA could be stronger to have the storyline be more impactful |
